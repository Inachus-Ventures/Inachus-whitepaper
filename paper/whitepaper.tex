...
\title{The Inachus.io Whitepaper} % Article title
\author{
  \textsc{Daniel Kaminski de Souza}\thanks{A thank you or further information} \\[1ex] % Your name
  \normalsize Inachus Ventures Hyper \\ % Your institution
  \normalsize \href{mailto:daniel@inachus.ventures}{daniel@inachus.ventures} % Your email address
  \and % Uncomment if 2 authors are required, duplicate these 4 lines if more
  \textsc{Amish Patel}\thanks{A thank you or further information} \\[1ex] % Your name
